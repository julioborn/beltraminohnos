      ...
      <div className="grid w-full max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
        {ITEMS.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="group flex flex-col items-center gap-3 rounded-2xl border border-black/10 bg-white px-5 py-7 text-center shadow-sm transition-colors hover:border-btm-navy"
          >
            <span className="flex h-14 w-14 items-center justify-center rounded-full bg-btm-navy/10 text-btm-navy transition-colors group-hover:bg-btm-navy group-hover:text-white">
              {item.icon}
            </span>
